...
const MainProduct = ({ setIsImageViewerOpen }: any) => {
    ...
    const products = [
        ...
        },
        {
            ...
            price: "$120.00",
            image:
                "https://websitedemos.net/plant-shop-02/wp-content/uploads/sites/931/2021/08/plants-ecommerce-product-featured-img-5.jpg",
            contact: "+91 123-456-7890",
        },
        {
            id: 3,
            ...
            price: "$120.00",
            image:
                "https://websitedemos.net/plant-shop-02/wp-content/uploads/sites/931/2021/08/plants-ecommerce-product-featured-img-14.jpg",
            contact: "+91 123-456-7890",
        },
    ];
    ...
    const sliderSettings = {
        ...
        autoplaySpeed: 3000,
        arrows: false,
        dots: true, // Enable the pagination dots
    };
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-[48%_48%] gap-[4%]">
                        ...
                        <div className="flex flex-col gap-5">
                            ...
                            <p className="max-w-[400px] text-sm text-[#353535] font-normal">
                                ...
                                iusto culpa enim exercitationem! Laborum sequi dolorum alias
                                expedita? Quo doloribus exercitationem minus iste velit
                                molestiae aut saepe placeat fugit porro!.
                            </p>
                        </div>
                    </div>
                        ...
                        <div className="flex flex-col gap-7 mt-5">
                            ...
                            <div>
                                <img
                                    ...
                                    alt=""
                                    className="w-full h-[400px] h-full object-cover"
                                />
                            </div>
                            ...
                            <div className="flex flex-col justify-start md:flex-row gap-4 sm:gap-0 w-full">
                                ...
                                <div className="flex flex-col gap-3">
                                    <li className="text-primary text-sm pb-2">
