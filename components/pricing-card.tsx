...
const PricingCard = ({name , price , features}: categories) => {
  return (
   <div className="flex items-center cursor-pointer">
        <div className="bg-light hover:bg-light-gray hover:text-secondary transition duration-300 ease-in-out rounded-lg hover:shadow-3xl p-6 max-w-sm w-full">
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS9VQEBjCgG4pvYgf01DF84YNSb2N2biill7Q&usqp=CAU" alt="Product Image" className="w-full h-36 mx-auto rounded-md mb-4 object-cover" />
            ...
            <a href="#" className="block bg-white hover:bg-secondary text-secondary hover:text-white font-medium transition duration-300 ease-in-out px-4 py-2 mt-6 rounded-lg text-center">Shop Now</a>
        </div>
      </div>
  )
}
